...
import { Menu, Shield, LayoutDashboard, Briefcase, Building2, UserCog, Settings, LogOut, Scale, Banknote } from "lucide-react";
...
const navItems = [
  ...
  { label: "Collections", icon: Banknote, href: "/admin/collections" },
